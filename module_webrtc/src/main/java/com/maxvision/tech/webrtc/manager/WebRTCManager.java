...
import com.maxvision.tech.webrtc.ws.ISignalingEvents;
import com.maxvision.tech.webrtc.ws.IWebSocket;
import com.maxvision.tech.webrtc.ws.JavaWebSocket;
...
public class WebRTCManager implements ISignalingEvents {
    ...
    // connect
    public void connect(boolean audioEnable, boolean videoEnable, String roomId) {
        if (_webSocket == null) {
            _mediaType = videoEnable ? MediaType.TYPE_VIDEO : MediaType.TYPE_AUDIO;
    ...
    public void toggleHeadset(boolean isHeadset) {
        if (_peerHelper != null) {
            _peerHelper.toggleHeadset(isHeadset);
        }
    }
    ...
    public void onJoinToRoom(ArrayList<String> connections, String myId) {
        handler.post(() -> {
            if (_peerHelper != null) {
                _peerHelper.onJoinToRoom(connections, myId, _audioEnable, _videoEnable, _mediaType);
